...
<template>
    <div class="background h-screen w-screen bg-[#16191f] flex flex-col items-center justify-center">
        <div class="w-[557px] h-[440px] border-[0.8px] border-[#1b2731] bg-[#2a2b2b] mt-16 rounded-[12px]">
            <div class="w-[555.4px] h-[450.4px] p-[32.5px] items-center flex flex-col">
                ...
                <div class="nickname flex flex-wrap gap-2 justify-center mt-3">
                    <div class="h-[24.35px] w-[88.77px] px-[9.75px] py-[3.25px] border-[0.8px] border-[#ffffff] text-white rounded-full flex justify-center items-center">WEB</div>
                    <div class="h-[24.35px] w-[88.77px] px-[9.75px] py-[3.25px] border-[0.8px] border-[#ffffff] text-white rounded-full flex justify-center items-center">IT</div>
                </div>
                <div class="nickname mt-5 text-[#9b9592]">
                Hi there!
                </div>
                <div class="nickname text-[#9b9592]">
                    I am trying to become a Web-developer.
                </div>
                <br>
                <hr class="w-[490.4px] h-[0.8px]">
                <br>
                <div class="profile theme-color">Welcome to my profile.</div>
                <br>
        ...
        <div class="flex justify-between gap-4 mt-6">
            <div class="w-[271px] h-[67px] p-3 border-[0.8px] flex items-center border-[#1b2731] rounded-lg bg-[#2a2b2b]">
                <div class="h-[45.5px] w-[45.5px] border-[0.8px] flex justify-center items-center bg-[#1f252b] rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M20.317 4.3698a19.7913 19.7913 0 00-4.8851-1.5152.0741.0741 0 00-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 00-.0785-.037 19.7363 19.7363 0 00-4.8852 1.515.0699.0699 0 00-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 00.0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 00.0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 00-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 01-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 01.0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 01.0785.0095c.1202.099.246.1981.3728.2924a.077.077 0 01-.0066.1276 12.2986 12.2986 0 01-1.873.8914.0766.0766 0 00-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 00.0842.0286c1.961-.6067 3.9495-1.5219 6.0023-3.0294a.077.077 0 00.0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.061 0 00-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.946 2.4189-2.1568 2.4189Z"></path></svg>
                </div>
                <div class="profile ml-2 text-white text-[17px]">ggahramaq</div>
                <div class="ml-auto cursor-pointer" @click="copyNickname"> 
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path d="m6 19v2c0 .621.52 1 1 1h2v-1.5h-1.5v-1.5zm7.5 3h-3.5v-1.5h3.5zm4.5 0h-3.5v-1.5h3.5zm4-3h-1.5v1.5h-1.5v1.5h2c.478 0 1-.379 1-1zm-1.5-1v-3.363h1.5v3.363zm0-4.363v-3.637h1.5v3.637zm-13-3.637v3.637h-1.5v-3.637zm11.5-4v1.5h1.5v1.5h1.5v-2c0-.478-.379-1-1-1zm-10 0h-2c-.62 0-1 .519-1 1v2h1.5v-1.5h1.5zm4.5 1.5h-3.5v-1.5h3.5zm3-1.5v-2.5h-13v13h2.5v-1.863h1.5v3.363h-4.5c-.48 0-1-.379-1-1v-14c0-.481.38-1 1-1h14c.621 0 1 .522 1 1v4.5h-3.5v-1.5z"></path></svg>
                </div>
            </div>
            <div class="w-[271px] h-[67px] p-3 border-[0.8px] flex items-center border-[#1b2731] rounded-lg bg-[#2a2b2b]">
                <div class="h-[45.5px] w-[45.5px] border-[0.8px] flex justify-center items-center bg-[#1f252b] rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 30 30"> <path d="M15,3C8.373,3,3,8.373,3,15c0,5.623,3.872,10.328,9.092,11.63C12.036,26.468,12,26.28,12,26.047v-2.051 c-0.487,0-1.303,0-1.508,0c-0.821,0-1.551-0.353-1.905-1.009c-0.393-0.729-0.461-1.844-1.435-2.526 c-0.289-0.227-0.069-0.486,0.264-0.451c0.615,0.174,1.125,0.596,1.605,1.222c0.478,0.627,0.703,0.769,1.596,0.769 c0.433,0,1.081-0.025,1.691-0.121c0.328-0.833,0.895-1.6,1.588-1.962c-3.996-0.411-5.903-2.399-5.903-5.098 c0-1.162,0.495-2.286,1.336-3.233C9.053,10.647,8.706,8.73,9.435,8c1.798,0,2.885,1.166,3.146,1.481C13.477,9.174,14.461,9,15.495,9 c1.036,0,2.024,0.174,2.922,0.483C18.675,9.17,19.763,8,21.565,8c0.732,0.731,0.381,2.656,0.102,3.594 c0.836,0.945,1.328,2.066,1.328,3.226c0,2.697-1.904,4.684-5.894,5.097C18.199,20.49,19,22.1,19,23.313v2.734 c0,0.104-0.023,0.179-0.035,0.268C23.641,24.676,27,20.236,27,15C27,8.373,21.627,3,15,3z"></path></svg>
                </div>
                <div class="profile ml-2 text-white text-[17px]">Ggahramaq</div>
                <div class="ml-auto cursor-pointer">
                    <a href="https://github.com/Ggahramaq">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path d="M16.6 17a1 1 0 0 1-.6-1v-2.5H3a1 1 0 0 1-1-1v-1q0-1 1-1h13V8a1 1 0 0 1 1.7-.7l4 4q.6.7 0 1.4l-4 4a1 1 0 0 1-1 .2"></path></svg>
                    </a>
                </div>
            </div>
        </div>
